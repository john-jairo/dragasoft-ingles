...
@Named("estadoOrdenController")
@SessionScoped
public class EstadoOrdenController implements Serializable {

    @EJB
    private login.controlador.EstadoOrdenFacade ejbFacade;
    ...
    public EstadoOrden getEstadoOrden(java.lang.Integer id) {
    ...
    public static class EstadoOrdenControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            return controller.getEstadoOrden(getKey(value));
        }
