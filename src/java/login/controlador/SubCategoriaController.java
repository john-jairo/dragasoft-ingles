...
public class SubCategoriaController implements Serializable {
    ...
    @EJB
    private login.controlador.SubCategoriaFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle").getString("SubCategoriaCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle").getString("SubCategoriaUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle").getString("SubCategoriaDeleted"));
        if (!JsfUtil.isValidationFailed()) {
